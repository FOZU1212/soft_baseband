...
//BCC编码
extern void BCC_encoder(unsigned char *data_scramble, int ScrLength, int N_SYM, unsigned int **code_out, int CodeLength);
//调制函数
extern void modulate(unsigned int **code_out , int BCC_length, int N_SYM, complex32 **sym_mod, int *NumSampEffect );
//插入导频零频
