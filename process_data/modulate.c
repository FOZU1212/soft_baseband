...
void bi2de(unsigned int **code_out, int BCC_length, int mode );
void Modulation_11ax(unsigned int **code_out, int *NumSampEffect, int mode, complex32 **sym_mod);

void modulate(unsigned int **code_out ,int BCC_length , int N_SYM, complex32 **sym_mod, int *NumSampEffect)
{
